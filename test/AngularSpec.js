...
describe('angular', function() {
  ...
  describe("extend", function() {
    ...
    it('should copy the properties of the source object onto the destination object', function(){
      ...
      expect(destination.hasOwnProperty('foo')).toBe(true);
    });
		...
		it('ISSUE #4751 - should copy the length property of an object source to the destination object', function(){
			...
			destination = extend(destination, source);
			expect(destination.hasOwnProperty('length')).toBe(true);
			expect(destination.hasOwnProperty('radius')).toBe(true);
		});
  ...
  describe('isArrayLike', function() {
    ...
    it('should return true for the arguments object', function(){
      ...
      expect(testFunction(null)).toBe(true);
    });
  });
